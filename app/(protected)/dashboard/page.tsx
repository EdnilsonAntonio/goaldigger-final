    ...
    useEffect(() => {
        ...
        const fetchDashboardData = async () => {
            try {
                ...
                // Get recent goals with progress
                                ...
                                {stats.recentGoals.map((goal) => (
                                    <div key={goal.id} className="bg-neutral-900/50 rounded-lg p-4 border border-neutral-700">
                                        ...
                                        <div className="flex items-center justify-between text-xs text-neutral-400">
                                            <span>{goal.current} / {goal.target} {goal.target ? '' : ''}</span>
                                            {goal.deadline && (
                            ...
                            <div className="space-y-3">
                                {stats.upcomingDeadlines.map((item) => {
                                    ...
                                    return (
                                        <div 
                                            key={item.id} 
                                            className={`bg-neutral-900/50 rounded-lg p-3 border ${
                                                isUrgent ? 'border-red-600/50' : 'border-neutral-700'
                                            }`}
                                        >
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className={`text-3xl font-bold ${
                                        stats.transactions.netBalance >= 0 ? 'text-green-400' : 'text-red-400'
                                    }`}>
